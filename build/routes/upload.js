    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                idsArquivosSalvos = [];
                quantidadeErroGravacao = 0;
                quantidadeErroObjArquivoInvalido = 0;
                quantidadeErroInesperado = 0;
                promises = nomesArquivos.map(function (arquivo) { return __awaiter(void 0, void 0, void 0, function () {
                    var objArquivo, nomeEmpresa, idArquivo, erro_1;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                objArquivo = req.files ? req.files[arquivo] : null;
                                nomeEmpresa = req.query.nomeEmpresa;
                                _a.label = 1;
                            case 1:
                                _a.trys.push([1, 3, , 4]);
                                return [4 /*yield*/, arquivoCtrl.realizarUpload(objArquivo, String(nomeEmpresa))];
                            case 2:
                                idArquivo = _a.sent();
                            ...
                            case 3:
                                erro_1 = _a.sent();
                                switch (erro_1) {
                                    case ArquivoController_1.ErroUpload.NAO_FOI_POSSIVEL_GRAVAR:
